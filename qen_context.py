...
API_ENDPOINTS_ATTIVI = {
    ...
    "POST /copilot-analyze": "QEN Sovereign Intelligence runtime",
    ...
    "POST /agents/mistral-compliance": "Legacy compatibility endpoint (deprecated)",
    "POST /agents/mistral-advisor": "Legacy compatibility endpoint (deprecated)",
    "POST /agents/bolkestein-assessment": "QEN Sovereign Bolkestein Assessment Engine",
