...
| Governance Activity | CEA | CGA | CKA | EDA | IA | AIGA | KGA | RM |
|---------------------|:--:|:--:|:--:|:--:|:--:|:---:|:---:|:--:|
| Governance Definition | A | R | C | C | C | C | C | I |
| Architecture Documentation | A | C | C | R | C | C | C | I |
| Repository Governance | C | C | C | C | I | I | I | A/R |
| Framework Governance | A | R | C | C | C | C | C | I |
| Evidence Governance | C | A | C | R | C | C | C | I |
| Validation Governance | C | A | C | R | C | C | C | I |
| Knowledge Governance | C | C | A | C | C | C | R | I |
| Documentation Integrity | C | C | C | A/R | C | I | C | C |
| Version Management | I | I | I | C | I | I | I | A/R |
